...
<div class="input-group">
                <div class="input-box">
                    <input type="text" placeholder=""  required  class="name" name="price" value=" {{ (isset($products) && $products->ProductName ) ? $products->ProductName : ''}}" >

                </div>
<div class="input-box">
                   <span name="product" class="text-secondary"><input type="text" placeholder=" Rentin Price" required class="name"   name="price" value=" {{ (isset($products) && $products->rentingPrice ) ? $products->rentingPrice : ''}}">
    ...
    @php
    $booking_no =0;
    $booking_no = rand(1000,10000);
    @endphp
<h4>Booking NO. </h4>
<div class="input-group">
                <div class="input-box">
                    <input type="number" placeholder="booking " required  class="name"name="booking_no"  value="{{ isset($booking_no) ? $booking_no :'' }}">
